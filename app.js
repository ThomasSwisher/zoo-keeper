...
import Panda from "./model/panda.js";
...
let Eddie = new Elephant("Eddie", "grey", "f", 2000, 36, "large");
let Freddy = new Frog("Freddy", "green", "m", 2, 10,);
...
// use .push() to create a collection
